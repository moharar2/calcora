...
export default function App() { return <ErrorBoundary><ThemeProvider defaultTheme="light"><TooltipProvider><Toaster /><InitialSeoRuntime /><Router /></TooltipProvider></ThemeProvider></ErrorBoundary>; }